...
public class Staff
{
    ...
    public Staff()
    {
        ...
        staffList[3] = new TempEmployee("Mark", "Address 4", "554-444-444", "12-2455-2345", 20.00);
        staffList[4] = new StaffEmployee("Daisy", "Address 5", "444-333-333", "15-3335-3532",1000.00);
        staffList[5] = new TempEmployee("Barney", "Address 6", "333-333-333", "42-7643-3552",1000.00);
